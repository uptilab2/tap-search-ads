...
- date_segment: Segment the report by date (optional: current list available segment date: 'date', 'monthStart', 'monthEnd', 'quarterStart', 'quarterEnd', 'weekStart', 'weekEnd', 'yearStart', 'yearEnd')
